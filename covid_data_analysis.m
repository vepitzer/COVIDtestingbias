...
% Define date range
date=[2020*ones(28,1) 3*ones(28,1) (4:31)'; 2020*ones(30,1) 4*ones(30,1) (1:30)'; 2020*ones(31,1) 5*ones(31,1) (1:31)'; 2020*ones(30,1) 6*ones(30,1) (1:30)'; 2020*ones(12,1) 7*ones(12,1) (1:12)'];
dateUS=datenum(date);
...
set(ax(1),'XLim',[dateUS(1)-3 dateUS(end)-3],'XTick',[dateUS(1)-3; dateUS([59 120],1)],'XTickLabel',{'Mar-01','May-01','Jul-01'},'YColor','k','FontSize',8)
set(ax(2),'XLim',[dateUS(1)-3 dateUS(end)-3],'XTick',[dateUS(1)-3; dateUS([59 120],1)],'XTickLabel',{'Mar-01','May-01','Jul-01'},'YColor','k','FontSize',8)
...
% Rename first 4 columns "daily_date", "datily_state", "positive", "negative"
...
%% Calculate and plot Rt for each state
...
for i=1:51
    [st_test_r(:,i),~,st_test_rstats(i)]=glmfit((1:103)',10000*newtests_bystate(29:end,i)./pop_bystate(i),'Poisson');
...
subplot(2,6,i+6)
hold on
plot(dateUS(29:end),glmval(st_test_r,(1:103)','log'),'Color',[.7 .7 .7])
plot(dateUS(29:end),10000*newtests_bystate(29:end,st(i))./pop_bystate(st(i)),'r')
plot(dateUS(29:end),glmval(st_test_r(:,st(i)),(1:103)','log'),'k')
datetick('x','mmm-dd')
xlim([dateUS(28) dateUS(end)+1])
set(gca,'XTick',dateUS([29 90]),'XTickLabel',{'Apr-01','Jun-01'})
ylim([0 50])
if i==1
ylabel('# of tests (per 10K)')
end
...
for i=1:51
    ...
    xlim([dateUS(1)-3 dateUS(end)+1])
    ylim([0 15])
    set(gca,'YTick',0:5:15,'XTick',[dateUS(1)-3 dateUS(120)],'XTickLabel',{'Mar1','Jul1'},'FontSize',8)
    title(states(i)) 
end
...
plot(dateUS(1:end-1,1),Rt_US,'Color',':k')
